  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        'border-gray-elements bg-transparent',
        'hover:border-gray-secondary',
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        'py-1.5 pr-8 pl-2 text-sm text-(--color-gray-secondary) outline-hidden transition-colors select-none',

        'focus:bg-[--gray-primary] focus:text-(--color-gray-primary) data-disabled:cursor-not-allowed',
